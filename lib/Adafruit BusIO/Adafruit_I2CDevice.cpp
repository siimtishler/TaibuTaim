 ...
 */
bool Adafruit_I2CDevice::begin(bool addr_detect, uint8_t sda, uint8_t scl)
{
	_wire->begin(sda, scl);
	_begun = true;
	_scl = scl;
...
bool Adafruit_I2CDevice::detected(void)
{
	...
	if (!_begun && !begin(true,_sda,_scl))
	{
		return false;
	}
...
void Adafruit_I2CDevice::changeAddress(uint16_t adr) { _addr = adr; }
